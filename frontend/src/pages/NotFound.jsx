  ...
  return (
    <div className="landing-page">
      ...
      <main className="container notfound-main">
        ...
        <h1 className="notfound-title" style={{ fontSize: '2.4rem', fontWeight: 700, letterSpacing: '-0.04em', margin: 0, color: 'var(--lp-text)' }}>
        ...
        <div className="notfound-actions" style={{ marginTop: 28, display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
          <Link
            to="/"
            style={{
              padding: '10px 20px',
